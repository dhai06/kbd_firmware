...
/* 
    this means left shift by n bits, can easily combine multiple modifiers using bitwise OR
    since we are bitmasking
    eg. send left ctrl + left shift:
    modifiers = KEYBOARD_MODIFIER_LEFTCTRL | KEYBOARD_MODIFIER_LEFTSHIFT;
*/
#define TU_BIT(n)   (1UL << (n)) 

// NKRO report struct
// 1 byte modifiers + 15 bytes bitmap = 16 bytes total
typedef struct {
